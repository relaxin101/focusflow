    ...
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white overflow-hidden border border-solid border-black w-[393px] h-[852px] relative">
        ...
        <header className="absolute w-[393px] h-[60px] top-0 left-0 bg-[#5586c94c]">
          <div className="absolute w-[336px] h-[30px] top-4 left-2">
          ...
          <Button
            variant="ghost"
            className="absolute w-[30px] h-[30px] top-4 left-[351px] bg-celestial-blue rounded-[5px] p-0 flex items-center justify-center"
          >
        ...
        {/* Course list */}
        <main className="absolute top-[60px] left-0 w-full overflow-y-auto">
